...
def private(update, context):
	...
	update.message.reply_text("Hello. This AFK Bot has no functions in PM. To use this bot in your groups, you need to host your own bot.", reply_markup = reply_markup)
	...
	for member in update.message.new_chat_members:
		if member.username == "CAPS_TV_AFKBot":
			if update.message.chat.id != int(os.environ.get("CHAT_ID")):
				update.message.reply_document("https://rojserbest.github.io/caps-tv-afk-telegram-bot/EC04BA5E-7D75-47A6-A302-8176AA9EFA96.gif")
